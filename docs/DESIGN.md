...
> Design notes for **marketplace-stale-listing-sweep** — a runnable python example that Schedule a nightly Python sweep that removes stale marketplace listings from a storefront catalog.
...
- **Feature code** — the actual task: marketplace-cleanup.
